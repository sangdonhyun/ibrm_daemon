...
class ov_mon():
    ...
    def evt_send(self,tg_job_dtl_id,tg='T'):
        query="""
        SELECT 
        ...
        print 'evt job info :',job_info
        print 'job_info :',job_info
        print job_info.keys()
        print 'db_id' in job_info.keys()
        self.set_event(job_info,tg)
    ...
    def set_event(self,job_info,tg='T'):
        ...
        if tg=='T':
            ...
            evt_info['evt_type'] = 'JOB_RUN_START_EVENT'
            evt_info['evt_code'] = 'JOB_RUN_START_EVENT'
        elif tg=='E':
            evt_info['evt_msg'] = 'DB ({}) FILE ({})  JOB END EVENT   JOB END TIME :{}'.format(job_info['db_nm'],job_info['sh_file_nm'],job_info['mod_dt'])
            evt_info['evt_type'] = 'JOB_RUN_END_EVENT'
            evt_info['evt_code'] = 'JOB_RUN_END_EVENT'
        ...
        print 'evt_mag :',evt_info['evt_msg']
